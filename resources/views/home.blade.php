...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col s6 border-2 hover:border-green-200 hoverable z-depth-5 yellow lighten-1">
                ...
                <a href="{{route('show.all.books')}}" class="btn m-4 ml-0 waves-effect waves-light amber lighten-3 black-text shadow-lg">Show All Books</a>
            </div>
            @if(session()->has('student_id'))
                <div class="col s5 border-2 hoverable z-depth-5 hover:border-green-200 light-green accent-2">
                    <ul class="collection with-header">
                    ...
                    <a href="{{route('show.all.orders')}}" class="btn m-4 ml-0 waves-effect waves-light amber lighten-3 black-text shadow-lg">Show All Orders</a>
                </div>
            @elseif(session()->has('librarian_id'))
                <div class="col s5 border-2 hoverable z-depth-5 hover:border-green-200  light-blue lighten-2">
                    <ul class="collection with-header">
                    ...
                    <a href="{{route('show.all.requests')}}" class="btn m-4 ml-0 waves-effect waves-light amber lighten-3 black-text shadow-lg">Show All Requests</a>
                </div>
            @endif
        </div>
        @if(session()->has('librarian_id'))
            <div class="row">
                <div class="col s6 border-2 hover:border-green-200 hoverable z-depth-5 yellow lighten-1">
                    ...
                    <a href="{{route('show.all.recommend')}}" class="btn m-4 ml-0 waves-effect waves-light amber lighten-3 black-text shadow-lg">Show All Recommendation</a>
                </div>
            </div>
        @endif
    </div>
